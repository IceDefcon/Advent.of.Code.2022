...
int main(int argc, char const *argv[])
{
    ...
    for (int i = 0; i < files; ++i)
    {
        cout << "folder_size " << file_object[i].folder.folder_size << " folder_name " << file_object[i].folder.folder_name << " file_object "<< i << " file_y " << file_object[i].file_y << " file_z " << file_object[i].file_z << " file_size " << file_object[i].file_size << endl;
    }
